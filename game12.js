...
//   if (i < 12) topEdge = true;
//   if (i % 12 === 0) leftEdge = true;
//   if (i >= 132) bottomEdge = true;
//   if ((i - 11) % 12 === 0) rightEdge = true;
//   let topVertex = (i - 12).toString();
//   let leftVertex = (i - 1).toString();
//   let rightVertex = (i + 1).toString();
//   let bottomVertex = (i + 12).toString();
//   switch (true) {
...
document.addEventListener('keydown', function(event) {
    ...
    if(event.keyCode == 37) {
        ...
        if (actionOrders.length > 1 && actionOrders[actionOrders.length - 2] === "down") {
            bar.classList.add("down-left");
        } else if (actionOrders.length > 1 && actionOrders[actionOrders.length - 2] === "up") {
        ...
        var bar = document.createElement('div');
        if (actionOrders.length > 1 && actionOrders[actionOrders.length - 2] === "right") {
            bar.classList.add("down-left");
        } else if (actionOrders.length > 1 && actionOrders[actionOrders.length - 2] === "left") {
            bar.classList.add("down-right");
        } else {
